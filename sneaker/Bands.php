        ...
        <div class="Gride-tool">   
            <div class="Search-Map">
                ...
                <div class="Search-band-Tool">แบรนด์
                    ...
                    ?>
                        <div class="checkbox-Search-Tool">
                            <?php if ($row['prd_brand']!=$_GET['Band']) : ?>
                            <input type="checkbox" class="input common_selector" value="<?=$row['prd_brand'];?>" id="brand">    <?= $row["prd_brand"]?>
                            <?php endif ?>
                            <?php if ($row['prd_brand']==$_GET['Band']) : ?>
                            <input type="checkbox" class="input common_selector" value="<?=$row['prd_brand'];?>" id="brand" checked>    <?= $row["prd_brand"]?>
                            <?php endif ?> 
                        </div>
                    <?php } ?> 
                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                function filter_data()
                {
                    ...
                    url:"Tool.php",
                    method:"POST",
                    data:{actionBand:actionBand,status:status,brand:brand,type:type,gender:gender,minimum_price:minimum_price,maximum_price:maximum_price,MaxorMin:MaxorMin,MapMarket:MapMarket,rating:rating,page:page},
